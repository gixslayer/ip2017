...
************************************************************************/
enum Sorteermethode { Insertion, Selection, Bubble, InsertionBonus, Heap, AantalMethoden };
string sorteermethode[] = { "insertion", "selection", "bubble","insertion (bonus)", "heap sort" };
